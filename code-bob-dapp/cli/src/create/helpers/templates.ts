...
export async function downloadAndExtractRepo(
  ...
  console.log("Downloading files from repo...",`https://codeload.github.com/Abhijeet1520/${name}/tar.gz/master`);

  const tempFile = await downloadTar(`https://codeload.github.com/Abhijeet1520/${name}/tar.gz/master`);
